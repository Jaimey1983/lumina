# LUMINA_CONTEXT_V34.md
> Generado: 04/06/2026 — Sesión 04/06/2026
> Reemplaza: LUMINA_CONTEXT_V33.md
...
3. **Siempre leer contexto primero** — todo prompt debe iniciar con "Lee LUMINA_CONTEXT_V34.md antes de empezar."
...
### GRUPO 4 — Actividades nuevas ← SIGUIENTE
...
- Puzzle game: 4 modalidades — drag-drop imagen, ordenar palabras, sliding tiles, reveal-on-answer (`puzzle_reveal` = prioridad pedagógica máxima)
- Breakout Rooms
- Team Mechanics
- Chat dual-purpose
...
```
[FRONTEND] Lee LUMINA_CONTEXT_V34.md y CLAUDE.md antes de empezar.
Archivo: src/...
[descripción del cambio]
Build debe pasar sin errores TypeScript.

[BACKEND] Lee LUMINA_CONTEXT_V34.md y .cursorrules antes de empezar.
Archivo: src/...
[descripción del cambio]
Build debe pasar sin errores TypeScript.
```
