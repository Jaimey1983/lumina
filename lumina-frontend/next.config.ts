...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ['@lumina/types', '@lumina/curriculum-data', '@lumina/ui', '@lumina/charts', '@lumina/editor-shared', '@lumina/scoring', '@lumina/element-kit-core', '@lumina/element-kit'],
  webpack: (config) => {
