...
import { useBlockDrag, getBlockPos, snapLineColor, snapPositionToGuides } from '@/hooks/use-block-drag';
  ...
  const handleResizeMove = useCallback(
    (
      ...
      const { x, y, lines } = snapPositionToGuides(
        ...
        peers,
        { guias: liveSlide.guias, enabled: !snapSuppressedRef.current },
      );
      setSnapLines(lines);
      return { x, y, ancho: rawCoords.ancho, alto: rawCoords.alto };
    },
    [liveSlide.bloques, liveSlide.guias, setSnapLines, snapSuppressedRef],
  );
