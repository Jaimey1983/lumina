/**
 * Espejo de `lumina-frontend/src/lib/activity-scoring.ts` (Fase 0.3).
 *
 * NO reinterpretar ni "mejorar" al portar. Si hace falta un cambio, se cambia
 * primero en el frontend y se re-porta.
 *
 ...
 * Espejo de lumina-frontend/src/lib/activity-scoring.ts — NO reinterpretar al portar.
 */
