...
import { generarGrid, seleccionEsPalabra, PalabraColocada } from './sopa-letras-config.js';
import { SOPA_LETRAS_GAP_PX, tamanoFuenteCeldaSopa, useSopaGridCellSize } from './sopa-letras-shared.js';
