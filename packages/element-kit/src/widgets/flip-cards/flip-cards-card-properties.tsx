...
import type { FlipCardsCaraLado, FlipCardsInnerSelection } from './flip-cards-config.js';
import { resolveCaraVisibilidad } from './flip-cards-card-utils.js';
import { mergedFlipCardsConfig } from './flip-cards-shared.js';
