...
import type { CarouselWidget, WidgetSlideContent, WidgetSlideInnerSelection } from '@lumina/types/widget';
...
import { TabsSlidePanelEditor } from '../tabs/tabs-slide-panel.js';
