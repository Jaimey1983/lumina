...
import { tabSelectionSlideId } from '../tabs/tabs-slide-utils.js';
...
export function CarouselWidgetComponentes({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="space-y-2">
        <WidgetSectionTitle>Visibilidad por defecto (páginas)</WidgetSectionTitle>
...
export function CarouselSlideProperties({
  ...
  return (
    <div className="flex flex-col gap-3">
      <WidgetSectionTitle>Página {slideIndex} — {slide.etiqueta}</WidgetSectionTitle>
      <p className="text-[10px] text-muted-foreground">
