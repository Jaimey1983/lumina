...
import { normalizeTimelineWidget, resizeTimelineNodos, type TimelineInnerSelection } from './timeline-config.js';
import { TIMELINE_LUCIDE_OPTIONS, TimelineLucideIcon } from './timeline-icon-catalog.js';
