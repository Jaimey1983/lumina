// Huecos iguales (ritmo) — portado verbatim de
// lumina-frontend/src/lib/canvas-spacing.ts (Etapa G, G0). Paridad en spacing.spec.ts.
...
function collectAxisGaps(others: RectPx[], axis: 'x' | 'y'): number[] {
