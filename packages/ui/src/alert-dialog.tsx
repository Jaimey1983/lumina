  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          // Mismo fix que Dialog (dialog.tsx): w-[calc(100%-2rem)] deja aire
          // a los lados en movil en vez de w-full pegado a los bordes, y
          // max-h/overflow-y-auto evita que un contenido alto quede
          // inaccesible sin scroll cuando el viewport es corto.
