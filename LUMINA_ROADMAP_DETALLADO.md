...
Grupos 1–5 · Grupo 9 (11 widgets) · Scoring unificado Fases 0–7 · AI Niveles 1–2 · **AI Nivel 3 BYOK multi-proveedor** · Sesiones/Gamificación base · Join/Guest · Editor drag/snap/guías base · 14 actividades Grupo 4 (editor+viewer+scoring) · **Fase 2 Clipping Masks (`clip-group`)** · **Fase 3 Canvas (auditoría + refinamiento editor)** · **Fase 5 Escape Room 2.0**
...
> Completada 26/08/2026 — ver `lumina-frontend/LUMINA_ROADMAP_DETALLADO.md` para detalle.

- [x] Bloque `clip-group`, formas, render, panel, rail, snap, tests visuales cross-browser
...
- [x] Auditoría canvas (3.1), refinamiento (3.2), undo/capas/zoom/grilla/align/cross-slide paste/miniaturas (3.3)
...
| App de escritorio (Tauri) | Alto | Bajo (nicho) | Solo demanda real |
