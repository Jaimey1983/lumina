...
import { WIDGET_FONT_OPTIONS } from '@/components/widgets/shared/widget-text-styles';
import {
...
function TextStyleFields({
  ...
  const fontValue =
    WIDGET_FONT_OPTIONS.find((f) => f.value === style.fontFamily)?.value ??
    WIDGET_FONT_OPTIONS[0].value;
